...
<body>
    ...
    <?php foreach($word as $word) { ?>
        ...
        <div style="border-left: 10px solid white; border-radius: 10px; padding: 10px" class="col-5 mb-4">
            ...
            <div class="form-group col-12" style="border: 1px solid grey">
                <label for="Email" class="control-label" style="color: white; font-size: 20px">Movie Booked:</label>
                <span class="ml-4" style=" color: aqua; font-size: 20px; font-weight: bold"><?php echo $word['tittle'] ?></span>
            </div>
        </div>
